# PostgreSQL Functions & Shit

#### [Walk Recursively Down Network](http://blog.cleverelephant.ca/2010/07/network-walking-in-postgis.html)
```SQL
...
#### [Random Points in Polygons](https://trac.osgeo.org/postgis/wiki/UserWikiRandomPoint)
```SQL
